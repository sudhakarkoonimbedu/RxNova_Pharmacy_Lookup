...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Claim_Verify_ContextualHelp.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_claim_verify_contextualhelp.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpClaimContextualHelp_TestRunner extends AbstractTestNGCucumberTests {
