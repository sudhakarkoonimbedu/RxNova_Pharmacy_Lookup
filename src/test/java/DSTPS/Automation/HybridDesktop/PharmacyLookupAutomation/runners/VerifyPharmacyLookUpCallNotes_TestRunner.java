...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_CallNotes_Verify_CallNotes.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_callnotes_verify_callnotes.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpCallNotes_TestRunner extends AbstractTestNGCucumberTests {
