...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Claim_Verify_DrugUtilizationReiewResponseDetails.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_claim_verify_drugutilizationreiewresponsedetails.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpClaimDrugUtilizationReiewResponseDetails_TestRunner extends AbstractTestNGCucumberTests {
