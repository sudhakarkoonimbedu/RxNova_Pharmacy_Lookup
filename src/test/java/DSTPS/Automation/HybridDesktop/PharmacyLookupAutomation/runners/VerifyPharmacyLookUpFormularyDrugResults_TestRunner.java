...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Formulary_Verify_DrugResults.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_formulary_verify_drugresults.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpFormularyDrugResults_TestRunner extends AbstractTestNGCucumberTests {
