...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_BenefitsEligibility_Verify_PartD.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_benefitseligibility_verify_partd.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpBenefitsAndEligibilityPartD_TestRunner extends AbstractTestNGCucumberTests {
