...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Authorization_Verify_CallNotes.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_authorization_verify_callnotes.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpAuthorizationCallNotes_TestRunner extends AbstractTestNGCucumberTests {
