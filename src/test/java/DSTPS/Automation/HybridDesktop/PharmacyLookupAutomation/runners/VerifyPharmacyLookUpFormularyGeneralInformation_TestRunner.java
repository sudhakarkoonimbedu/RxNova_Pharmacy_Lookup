...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Formulary_Verify_GeneralInformation.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_formulary_verify_generalinformation.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpFormularyGeneralInformation_TestRunner extends AbstractTestNGCucumberTests {
