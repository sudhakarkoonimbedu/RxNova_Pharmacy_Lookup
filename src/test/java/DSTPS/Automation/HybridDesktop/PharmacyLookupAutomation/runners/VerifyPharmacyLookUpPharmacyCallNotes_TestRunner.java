...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Pharmacy_Verify_CallNotes.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_pharmacy_verify_callnotes.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpPharmacyCallNotes_TestRunner extends AbstractTestNGCucumberTests {
