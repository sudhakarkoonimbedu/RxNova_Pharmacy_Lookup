...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_BenefitsEligibility_Verify_CallNotes.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_benefitseligibility_verify_callnotes.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpBenefitsEligibilityCallNotes_TestRunner extends AbstractTestNGCucumberTests {
