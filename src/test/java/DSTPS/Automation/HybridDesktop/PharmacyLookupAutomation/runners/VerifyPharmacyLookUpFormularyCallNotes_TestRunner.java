...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Formulary_Verify_CallNotes.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_formulary_verify_callnotes.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpFormularyCallNotes_TestRunner extends AbstractTestNGCucumberTests {
