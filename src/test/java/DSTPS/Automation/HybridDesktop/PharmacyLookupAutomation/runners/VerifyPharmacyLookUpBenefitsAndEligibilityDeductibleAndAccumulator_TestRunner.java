...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_BenefitsEligibility_Verify_Deduductible&Accumulators.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_benefitseligibility_verify_deduductible&accumulators.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpBenefitsAndEligibilityDeductibleAndAccumulator_TestRunner extends AbstractTestNGCucumberTests {
