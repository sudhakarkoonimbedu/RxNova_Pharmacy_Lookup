...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_BenefitsEligibility_Verify_B&EDetail.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_benefitseligibility_verify_b&edetail.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpBenefitsAndEligibilityDetail_TestRunner extends AbstractTestNGCucumberTests {
