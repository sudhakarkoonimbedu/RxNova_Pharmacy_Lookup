...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Claim_Verify_ClaimRawData.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_claim_verify_claimrawdata.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpClaimClaimRawData_TestRunner extends AbstractTestNGCucumberTests {
