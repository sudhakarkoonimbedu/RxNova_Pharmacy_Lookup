...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Authorization_Verify_GeneralInformation.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_authorization_verify_generalinformation.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpAuthorizationGeneralInformation_TestRunner extends AbstractTestNGCucumberTests {
