...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Reimbursement_Verify_ReimbursementResults.feature" },
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_reimbursement_verify_reimbursementresults.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpReimbursementResults_TestRunner extends AbstractTestNGCucumberTests {
