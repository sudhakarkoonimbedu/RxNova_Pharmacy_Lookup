...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Search_InvalidData.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_search_invaliddata.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class SearchPharmacyLookUpWithInvalidData_TestRunner extends AbstractTestNGCucumberTests {
