...
@CucumberOptions(
		features = {"classpath:features/PharmacyLookup/PharmacyLookup_Claim_Verify_TransferRulesCCInformation.feature" }, 
			tags = {"@Functional"}, 
			...
			plugin =  {"pretty","html:target/html", "json:pharmacylookup_claim_verify_transferrulesccinformation.json", "rerun:src/test/resources/rerun.txt"},
			strict=true
)

public class VerifyPharmacyLookUpClaimTransferRulesCCInformation_TestRunner extends AbstractTestNGCucumberTests {
