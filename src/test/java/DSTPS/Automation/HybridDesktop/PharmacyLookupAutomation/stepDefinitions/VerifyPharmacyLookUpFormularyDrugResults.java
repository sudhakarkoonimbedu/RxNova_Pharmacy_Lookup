...
import DSTPS.Automation.HybridDesktop.PharmacyLookupAutomation.steps.PharmacyLookup_Formulary_DrugResults_Steps;
import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;

public class VerifyPharmacyLookUpFormularyDrugResults {
	...
	public PharmacyLookup_Formulary_DrugResults_Steps pharmacyLookup_Formulary_DrugResults_Steps;
	
	public VerifyPharmacyLookUpFormularyDrugResults(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		pharmacyLookup_Formulary_DrugResults_Steps = new PharmacyLookup_Formulary_DrugResults_Steps(SharedResource,utils);
	}	
	
	
	@Then("^User click on Formulary icon$")
	public void user_click_on_formulary() throws Throwable{
		pharmacyLookup_Details_Steps.clickOnFormulary();
	}
	...
	public void verify_drug_results_details(Map<String,String> drugResultsDetails) throws Throwable{
		...
		pharmacyLookup_Formulary_DrugResults_Steps.verifyDrugResults(drugResultsDetails);
	}
	...
	public void verify_test_entry_details(Map<String,String> claimTestDetails) throws Throwable{
		pharmacyLookup_Formulary_DrugResults_Steps.verifyClaimTestDetails(claimTestDetails);
	}
