...
import DSTPS.Automation.HybridDesktop.PharmacyLookupAutomation.steps.PharmacyLookup_Formulary_CallNotes_Steps;
import cucumber.api.java.en.Then;

public class VerifyPharmacyLookUpFormularyCallNotes {
	...
	public PharmacyLookup_Formulary_CallNotes_Steps pharmacyLookup_Formulary_CallNotes_Steps;
	
	public VerifyPharmacyLookUpFormularyCallNotes(HybridDesktop_SharedResource SharedResource, RxNova_Utlilty utils) throws Throwable{
	...
	public void init() throws Throwable
	{
		...
		pharmacyLookup_Formulary_CallNotes_Steps = new PharmacyLookup_Formulary_CallNotes_Steps(SharedResource,utils);
	}	
	...
	public void user_click_on_call_notes() throws Throwable{
		...
		pharmacyLookup_Formulary_CallNotes_Steps.clickOnCallNotes();
	}
	...
	public void add_call_notes(Map<String,String> addCallNotesDetails) throws Throwable{
		pharmacyLookup_Formulary_CallNotes_Steps.provideCallNotesDetails(addCallNotesDetails);
		pharmacyLookup_Formulary_CallNotes_Steps.addCallNotes();
	}
	...
	public void verify_previous_call_notes_comments(Map<String,String> previousCallNotesComments) throws Throwable{
		pharmacyLookup_Formulary_CallNotes_Steps.verifyPreviousCallNotesComments(previousCallNotesComments);
	}
	...
	public void verify_call_notes_details(Map<String,String> callNotesDetails) throws Throwable{
		pharmacyLookup_Formulary_CallNotes_Steps.verifyCallNotesDetails(callNotesDetails);
	}
}
